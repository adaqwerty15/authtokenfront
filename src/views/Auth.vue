	...
	<div class="auth">
		<div class="limiter">
			<div class="container-login100">
				<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
					<form class="login100-form validate-form" v-on:submit.prevent="login">
						...
						<div class="wrap-input100 validate-input" v-bind:class="{ red: emailError }" data-validate = "Valid email is required: ex@abc.xyz">
							<input class="input100" type="text" name="email" v-model="email" placeholder="Email" required>
							<span class="focus-input100-1"></span>
							<span class="focus-input100-2"></span>
						</div>

						<div class="wrap-input100 rs1 validate-input" v-bind:class="{ red: passError }" data-validate="Password is required">
							<input class="input100" type="password" name="pass" v-model="pass" placeholder="Пароль" required>
							<span class="focus-input100-1"></span>
							<span class="focus-input100-2"></span>
						</div>
              ...
              <router-link class="txt2 hov1" to="/resetpass" exact>пароль?</router-link>
              ...
              <router-link class="txt2 hov1" to="/join" exact>Зарегистрироваться</router-link>
      ...
      login() {
        ...
        .then(data=> {
            ...
            if (data.refresh) {
              ...
              if (data.detail) {
                this.detail = "Неверный логин и (или) пароль";
                this.passError = true;
